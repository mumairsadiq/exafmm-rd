                                ...
                                for (const int body_idx_src : adj_cell.bodiesIndices)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else if (!srcp_in_tarc && !tarp_in_srcc)
                                        {
                                            ...
                                            // std::cout << body_src.x << "--" << body_tar.x << std::endl;
                                            // std::cout << body_src.x << "--" << body_tar.x << "--" << sif_x << "--" << sif_y << "--" << sif_z << "--" << tif_x
                                        ...
                                        else
                                        {
                                            ...
                                            if (in_rel_regx_src && in_rel_regx_tar)
                                            {
                                                ...
                                                // tested well, doesn't seem to be any more problems in this if block
                                                ...
                                                // tested well, but still vulnerable part
                                                else if (dist_z == 0)
                                                {
                                                    if (z_same_dir_tar)
                                                    {
                                                ...
                                                else if (dist_z == dist_2cells && dist_y == dist_2cells)
                                                {
                                                    if (!is_ysrc_bw_cells && !is_zsrc_bw_cells)
                                                    {
                                                        if (is_ytar_bw_cells && in_regy_tar)
                                                        {
                                                            // tested cases in_ztar_bw_cells && in_regz_tar
                                                            pair_list[body_idx_tar].push_back(body_idx_src);
                                                            pair_list_bxyz_tar[body_idx_tar].push_back({1, 0, bzt});
                                                            pair_list_tif_within[body_idx_tar].push_back({1, 0, tif_z});

                                                            pair_list_bxyz_src[body_idx_tar].push_back({1, 0, 0});
                                                            pair_list_sif_within[body_idx_tar].push_back({1, 1, 1});
                                                        }
                                                        else if (is_ztar_bw_cells && in_regz_tar)
                                                        {
                                                            // not tested
                                                            pair_list[body_idx_tar].push_back(body_idx_src);
                                                ...
                                                // if (in_rel_regy_tar && in_rel_regz_tar)
                                                // {
                                                //     std::cout << "Both Related: " << body_src.x << "--" << body_tar.x << std::endl;
                                                // }
                                                // else if (in_rel_regy_tar)
                                                // {
                                                //     std::cout << "Y Related: " << body_src.x << "--" << body_tar.x << std::endl;
                                                // }
                                                // else if (in_rel_regz_tar)
                                                // {
                                                //     std::cout << "Z Related: " << body_src.x << "--" << body_tar.x << std::endl;
                                                // }
                                                // else
                                                // {
                                                // }
                                            ...
                                            {
                                                // std::cout << "y: " << body_src.x << "--" << body_tar.x << std::endl;
                                            }
                                            else if (in_rel_regz_src && in_rel_regz_tar)
                                            {
                                                // std::cout << "z: " << body_src.x << "--" << body_tar.x << std::endl;
                                            }
                                            ...
                                            //                 if (in_regz_tar && in_regz_src && in_rel_regy_src)
                                            //                 {
